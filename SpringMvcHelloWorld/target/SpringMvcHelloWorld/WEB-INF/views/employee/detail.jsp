        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow">
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    ...
                    <h1 class="navbar-brand mb-0 h3">Employee Details</h1>
                </div>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="card-text text-muted small">Complete details for ${employee.name}</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="/SpringMvcHelloWorld/employee/edit/${employee.employeeId}" 
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                            <div class="text-center">
                                ...
                                <p class="text-muted fs-5">${employee.position}</p>
                                <small class="text-muted">Employee ID: ${employee.employeeId}</small>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="tel:${employee.contactNumber}" class="text-decoration-none">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <small class="text-muted fw-medium">Employee ID</small>
                                    </div>
                                    <p class="mb-0">${employee.employeeId}</p>
                                </div>
