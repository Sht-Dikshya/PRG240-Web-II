...
<head>
    ...
    <title>Employee Registration Summary - Spring MVC</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/style.css">
</head>
<body class="employee-summary">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-success" role="alert">
                            ...
                            <p>The employee has been registered successfully. Here are the details:</p>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                            <a href="${pageContext.request.contextPath}/employee/register" 
                               class="btn btn-primary btn-lg">Register Another Employee</a>
