...
<head>
    ...
    <title>User Registration - Spring MVC</title>
...
<body class="user-form">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="userForm" action="${pageContext.request.contextPath}/user/register" method="POST">
                            <div class="mb-3">
    ...
    <script>
        document.getElementById('userForm').addEventListener('submit', function(e) {
            ...
            // The form will be processed by the UserController.registerUser method
        });
