...
<head>
    ...
    <title>${formTitle} - NutriTime User Management System</title>
    ...
    <main class="container py-4">
        ...
        <div class="card shadow">
            <div class="card-header">
                <h5 class="card-title mb-1">NutriTime User Information</h5>
                <p class="card-text text-muted small">
                    <c:choose>
                        <c:when test="${formAction == 'add'}">
                            Please fill in the details to add a new NutriTime user.
                        </c:when>
                        <c:otherwise>
                            Please update the user information below.
                        </c:otherwise>
                    </c:choose>
                </p>
            </div>
            ...
            <form method="post"
                  action="/SpringMvcHelloWorld/login/${formAction}"
                  class="p-4">
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        ...
                        <ul class="mb-0 small">
                            ...
                            <li>Position should reflect the user's job title or role</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            [nameInput, emailInput, contactInput, positionInput].forEach(input => {
